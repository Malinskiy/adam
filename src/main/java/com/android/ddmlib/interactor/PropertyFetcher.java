...
public class PropertyFetcher {
    ...
    public static final Pattern GETPROP_PATTERN = Pattern.compile("^\\[([^]]+)\\]\\:\\s*\\[(.*)\\]$"); //$NON-NLS-1$
    public static final int GETPROP_TIMEOUT_SEC = 2;
    public static final int EXPECTED_PROP_COUNT = 150;
