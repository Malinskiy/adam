...
import com.android.ddmlib.model.client.AllocationTrackingStatus;
import com.android.ddmlib.model.client.IAllocationTrackingHandler;
import com.android.ddmlib.model.client.IHprofDumpHandler;
 ...
 */
final public class HandleHeap extends ChunkHandler {
...
//xxx todo: add to the heap mentioned in <data>
    ...
    private void handleREAL(Client client, ByteBuffer data) {
        ...
        IAllocationTrackingHandler handler = ClientData.getAllocationTrackingHandler();
