...
import com.android.ddmlib.exception.BadPacketException;
...
final public class JdwpPacket {
     ...
     */
    public void finishPacket(int payloadLength) {
        assert mIsNew;
     ...
     */
    public void writeAndConsume(SocketChannel chan) throws IOException {
        int oldLimit;
     ...
     */
    public void movePacket(ByteBuffer buf) {
