...
public class Debugger {
     ...
     * on a specific port.
     */
    public Debugger(Client client, int listenPort) throws IOException {
     ...
     */
    public void registerListener(Selector sel) throws IOException {
     ...
     * Returns "null" if we're already talking to somebody.
     */
    public synchronized SocketChannel accept(ServerSocketChannel listenChan)
        throws IOException {
     ...
     * Consumes the packet.
     */
    public void forwardPacketToClient(JdwpPacket packet) throws IOException {
     ...
     */
    public synchronized void sendAndConsume(JdwpPacket packet)
        throws IOException {
